...
?>
		...
		<form class="form-signin" method="post" action="<?php echo $sq_url.'index.php/Install/config_sq';?>" onSubmit="return agreetos();">
			...
			<div class="form-group">	 
					...
					<input type="text"  id="base_url" name="sq_base_url" class="form-control" value="<?php echo str_replace('index.php/Install/index/ph/','',str_replace('//index.php/Install/index/ph/','/',$sq_url));?>" placeholder="<?php echo $this->lang->line('hostname');?>" required autofocus >
			</div>
			<div class="form-group">	 
					<label for="inputEmail"  ><?php echo $this->lang->line('hostname');?></label> 
					<input type="text"   name="sq_hostname" class="form-control" value="<?php if(isset($_POST['sq_hostname'])){ echo $_POST['sq_hostname']; }?>" placeholder="<?php echo $this->lang->line('hostname');?>" required autofocus >
			</div>
			<div class="form-group">	 
					<label for="inputEmail" class="sr-only"><?php echo $this->lang->line('db_name');?></label> 
